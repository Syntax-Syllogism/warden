...
describe('userProvisioning planner', () => {
  const fieldMap = buildFieldMap([
    ...
    { name: 'Alias', createable: true, updateable: true },
    { name: 'Title', createable: true, updateable: true },
    { name: 'ProfileId', createable: true, updateable: true },
    { name: 'UserRoleId', createable: true, updateable: true },
  ]);
